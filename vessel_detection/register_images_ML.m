function [new_base_filename, new_corr_filename] = register_images_ML(...
	...
	%Get the vessel outline of each image using machine learning

	base_img = vessel_detection_lineop(base_img_real);
	next_img = vessel_detection_lineop(next_img_real);
      
    imwrite(base_img, [outputdir, '/', base_img_real_file, '-vessels.tif'], 'tif');
    imwrite(next_img, [outputdir, '/', next_img_real_file, '-vessels.tif'], 'tif');
