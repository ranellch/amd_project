function analyze_eye(pid, eye)
    ...
    input_file = 'good mcw images.txt';
    disp(['Reading times to use from ',input_file])
    ...
    %Run through the images and find the ones for this eye
    for k=1:numimages
       pid = char(images{1}{k});
       eye = char(images{2}{k});
       time = num2str((images{3}(k)));
