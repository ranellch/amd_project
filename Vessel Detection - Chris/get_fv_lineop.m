...
for length = [9, 15, 25]
    ...
    [mx_str, delta_str, ortho_str, mx_ang] = lineop_obj{count}.get_line_strengths(img);
    all_strengths = cat(3,all_strengths, mx_str);
    all_deltas = cat(3, all_deltas, delta_str);
...
fv_image = cat(3, fv_max, fv_delta, fv_ortho, fv_avg);
