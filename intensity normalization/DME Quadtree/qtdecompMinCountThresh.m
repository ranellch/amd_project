function [qt_sparse, dims] = qtdecompMinCountThresh(mask, thresh, disp_opt, overlayimg)
...
qt_sparse = qtdecomp(mask, @splitDecision);
...
if exist('disp_opt', 'var') && disp_opt
    ...
    figure; imshowpair(overlayimg, blocks, 'blend');
end
