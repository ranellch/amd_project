function analyze_hyper(rebuild_classifier)
    addpath('..');
    ...
    results_file = './results - hyper /analyze_results.txt';
    ...
    fid = fopen('hyper_draw.testing', 'r');
    ...
    for k=1:numimages
        ...
        imwrite(display_outline(original_img,calced_img,[1 0 0]), ['./results/',pid,'_',eye,'_',time,'-hyper.tif'], 'tiff');
